...
// v User can enter numbers as sequences up to 8 digits long by clicking on digits in the entry pad. Entry of any digits more than 8 will be ignored.
// v User can click on an operation button to display the result of that operation on:
//  the result of the preceding operation and the last number entered OR
//  the last two numbers entered OR
//  the last number entered
// v User can click the 'C' button to clear the last number or the last operation. If the users last entry was an operation the display will be updated to the value that preceded it.
// v User can click the 'AC' button to clear all internal work areas and to set the display to 0.
